...
var ShortToken_1 = require("./ShortToken");
var BeaconLocation_1 = require("./BeaconLocation");
var Rank;
(function (Rank) {
...
var User = /** @class */ (function (_super) {
    ...
    __decorate([
        typeorm_1.OneToMany(function (type) { return ShortToken_1.ShortToken; }, function (short_token) { return short_token.user; }),
        __metadata("design:type", Array)
    ], User.prototype, "short_tokens", void 0);
    __decorate([
    ...
    __decorate([
        typeorm_1.OneToMany(function (type) { return BeaconLocation_1.BeaconLocation; }, function (location) { return location.reporter; }),
        __metadata("design:type", Array)
    ], User.prototype, "beacon_locations", void 0);
