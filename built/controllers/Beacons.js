...
Beacons.push({
    ...
    method: 'post',
    handler: function (request, h) { return __awaiter(_this, void 0, void 0, function () {
        var user, _a, name, description, beacon, e_1, handler;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    user = request.auth.credentials.user;
                    _a = request.payload, name = _a.name, description = _a.description;
                    beacon = new Beacon_1.Beacon();
                    beacon.owner = user;
                    beacon.name = name;
                    beacon.description = description;
                    beacon.created_at = new Date();
                    return [4 /*yield*/, beacon.save()];
                case 1:
                    _b.sent();
