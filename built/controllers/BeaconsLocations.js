        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    beaconId = request.params.beaconId;
                    user = request.auth.credentials.user;
                    _a = request.payload, x = _a.x, y = _a.y;
                    location = new BeaconLocation_1.BeaconLocation();
                    location.beacon = { id: beaconId };
...
exports.default = BeaconsLocations;
//# sourceMappingURL=BeaconsLocations.js.map